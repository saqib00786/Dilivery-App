...
const RestaurantCards = ({
  ...
  return (
    ...
    >
      <Image source={{ uri: imageUrl }} className="w-52 h-48 rounded-tl-lg rounded-tr-lg object-contain" />
      ...
      <View className="pb-3 ">
        ...
        <View className="flex-row mt-1 px-2">
          ...
          <Text numberOfLines={1} className="text-gray-500 text-xs font-semibold px-2">
            Nearby * {address}
          </Text>
        </View>
      </View>
